...
from project.source.api import app
...
class TestApi(unittest.TestCase):
    ...
    def test_get_ping(self):
        ...
        self.assertEqual(response.json(), {"pong": "from economic-scenario-generator!"})
    ...
    def test_final_gbm_mean(self):
        ...
        analytic_mean = payload["s0"][0] * np.exp(payload["mu"][0] * payload["years"])
